...
class PlanningProjectDefinitionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        if ($request->status == 'close' || $request->status == 'Close') {
            ...
            executing_project_definitions::firstOrCreate([
            ...
            return redirect('/planning')->with('success', 'Data has been Updated!');
        } else {
            // kondisi jika status kembali ke open
