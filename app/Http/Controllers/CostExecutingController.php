...
class CostExecutingController extends Controller
{
    public function index()
    {
        ...
        $bebanBahan = executing_procurement_bebanBahan::all();
        $projectIncomeStatement = executing_cost_incomes::all();
        $listAssumsition = executing_cost_listAssumsition::all();
        return view('executing.costExecuting.index', compact('bebanBahan', 'projectIncomeStatement', 'caseflow', 'listAssumsition'));
    }
}
