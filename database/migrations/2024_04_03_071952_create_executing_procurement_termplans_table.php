...
class CreateExecutingProcurementTermplansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('executing_procurement_termplans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('executing_procurement_termplans');
    }
}
