...
class CreatePlanningComReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('planning_com_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('planning_com_reports');
    }
}
