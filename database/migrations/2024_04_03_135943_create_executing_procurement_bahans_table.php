...
class CreateExecutingProcurementBahansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('executing_procurement_bahans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('executing_procurement_bahans');
    }
}
