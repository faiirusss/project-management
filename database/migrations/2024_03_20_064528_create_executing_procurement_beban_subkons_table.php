...
class CreateExecutingProcurementBebanSubkonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('executing_procurement_beban_subkons', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('executing_procurement_beban_subkons');
    }
}
