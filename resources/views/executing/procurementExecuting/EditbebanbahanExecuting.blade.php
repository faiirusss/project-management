    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="/bebanbahanExecuting/{{ $bebanbahanExecuting->id }}/update" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="vendor" id="" value="{{$bebanbahanExecuting->vendor}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Description/ Service</label>
                            <input type="text" name="description_service" id="" value="{{$bebanbahanExecuting->description_service}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Volume</label>
                            <input type="text" name="volume" id="" value="{{$bebanbahanExecuting->volume}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Units</label>
                            <input type="text" name="units" id="" value="{{$bebanbahanExecuting->units}}" class="form-control mb-3 text-white"  required>
                        </div>   
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Total</label>
                            <input type="text" name="total" id="" value="{{$bebanbahanExecuting->total}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
