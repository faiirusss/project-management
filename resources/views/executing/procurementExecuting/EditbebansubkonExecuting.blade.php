    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="/bebansubkonExecuting/{{ $bebansubkonExecuting->id }}/update" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="vendor_subkon" id="" value="{{$bebansubkonExecuting->vendor_subkon}}"class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Description/ Service</label>
                            <input type="text" name="description_service_subkon" id="" value="{{$bebansubkonExecuting->description_service_subkon}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Volume</label>
                            <input type="text" name="volume_subkon" id="" value="{{$bebansubkonExecuting->volume_subkon}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Units</label>
                            <input type="text" name="units_subkon" id="" value="{{$bebansubkonExecuting->units_subkon}}" class="form-control mb-3 text-white"  required>
                        </div>   
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Total</label>
                            <input type="text" name="total_subkon" id="" value="{{$bebansubkonExecuting->total_subkon}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
