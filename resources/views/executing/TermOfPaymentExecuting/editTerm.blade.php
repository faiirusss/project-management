    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="/termOfPayment/{{ $TermOfPayment->id }}/update" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Term Type</label>
                            <input type="text" name="term_type" id="" value="{{$TermOfPayment->term_type}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Value (%)</label>
                            <input type="text" name="value_term" id="" value="{{$TermOfPayment->value_term}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Value (Rp)</label>
                            <input type="text" name="value_rp_term" id="" value="{{$TermOfPayment->value_rp_term}}" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Month (Plan)</label>
                            <input type="date" name="month_plan" id="" value="{{$TermOfPayment->month_plan}}" class="form-control mb-3 text-white"  required>
                        </div>
                    </div>
