        ...
        <div class="row mb-2">
            ...
            <div class="col-md-3">
                ...
                <select name="status" id="status" class="form-select mb-3 text-white" required>
                    <option value="Open" @if($executingFinal->status == "Open") selected @endif>Open</option>
                    <option value="Close" @if($executingFinal->status == "Close") selected @endif>Close</option>
                </select>
            </div>        
        </div>        
