...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <div class="navbar-nav align-items-center ms-auto">
            ...
            <a href="/finalExecuting" class="nav-link {{ \Request::is('stakeholder*','stakeholder') ? 'active':''}}" >
                <i class="fas fa-users-cog me-lg-2"></i>
                <span class="d-none d-lg-inline-flex">Final Executing</span>
            </a>
        </div>
    </center>
</nav>
...
<div class="col-sm-12 col-xl-10">
    <div class="bg-secondary rounded h-100 p-4">
        <form action="/finalExecuting/save" method="post">
            @csrf
        ...
        <div class="bg-light rounded p-4 mb-4">
            ...
            <div class="row mb-2">
                <div class="col-md-4">
                    <label for="bahan" class="form-label text-white">Beban Bahan</label>
                    <select name="bahan" id="bahan" class="form-select mb-3 text-white" required>
                        @foreach($bahan as $b)
                ...
                <div class="col-md-4">
                    <label for="subkon" class="form-label text-white">Beban Subkon</label>
                    <select name="subkon" id="subkon" class="form-select mb-3 text-white" required>
                        @foreach($subkon as $c)
                ...
                <div class="col-md-4">
                    <label for="termofpay" class="form-label text-white">Term Of Payment</label>
                    <select name="termofpay" id="termofpay" class="form-select mb-3 text-white" required>
                        @foreach($termofpay as $d)
        ...
        <div class="bg-light rounded p-4 mb-4">
            ...
            <div class="row mb-2">   
                ...
                <div class="col-md-4">
                    <label for="tagihan" class="form-label text-white">Term of Payment Plan</label>
                    <select name="tagihan" id="tagihan" class="form-select mb-3 text-white" required>
                        @foreach ($tagihan as $q)
            ...
            <a href="/finalExecuting" class="btn btn-sm btn-outline-warning m-2">Cancel</a>
        </form>
    </div>
</div>
@endsection
