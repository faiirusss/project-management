                    ...
                    <table class="table table-striped table-condensed">
                        <thead>
                            <tr class="text-white">
                                ...
                                <th valign="top"><small>Requirements</small></th>
                                <th valign="top"><small>Category</small></th>
                                <th valign="top"><small>Action</small></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($executingQuality as $u)
                            <tr class="text-white">
                                <td><small>{{$u->name_project}}</small></td>
                                <td><small>{{$u->requirements}}</small></td>
                                <td><small>{{$u->category}}</small></td>
                                <td><small>
                                    <a href="/qualityExecuting/{{$u->id}}/edit" class="btn btn-sm btn-outline-info m-2"><i class="fa fa-pen me-2"></i>Edit</a>   
                                    <a href="/qualityExecuting/{{$u->id}}/delete" class="btn btn-sm btn-outline-danger m-2" onclick="return confirm('are you sure to delete this?')"><i class="fa fa-trash me-2"></i>Delete</a>   
                                </small></td>
                            </tr>
                            @endforeach
                        </tbody>
