...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <div class="navbar-nav align-items-center ms-auto">
            ...
            <a href="/executingQuality" class="nav-link">
    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="/qualityExecuting/{{ $executingQuality->id }}/update" method="post">
            @csrf
            <div class="row mb-2">
                <div class="col-md-4">
                    <label for="name_project" class="form-label text-white">Name Project</label>
                    <input type="text" name="name_project" id="" value="{{$executingQuality->name_project}}" class="form-control bg-dark text-white mb-3">
                </div>
                <div class="col-md-4">
                    <label for="" class="form-label text-white">Requirements</label>
                    <input type="text" name="requirements" id="" value="{{$executingQuality->requirements}}" class="form-control mb-3 text-white"  required>
                </div>   
                <div class="col-md-4">
