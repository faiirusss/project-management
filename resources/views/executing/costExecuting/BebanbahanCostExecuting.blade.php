...
<div class="col-sm-12 col-xl-10">
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="/bebanBahanCostExecuting/store" method="POST">
            @csrf
        <div class="row mb-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="materialService" id="materialService" class="form-control mb-3 text-white" required>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="volume" id="volume" class="form-control mb-3 text-white" required>
            </div>
            <div class="col-md-4"> 
                <label for="unit" class="form-label text-white">Unit</label>
                <select name="unit" id="unit" class="form-control mb-3 text- bg-dark">
                    <option selected="true" disabled="disabled" hidden>Choose One</option>  
