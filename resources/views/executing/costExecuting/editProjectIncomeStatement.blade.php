...
<div class="col-sm-12 col-xl-10">
    <div class="bg-secondary rounded h-100 p-4">
        <h3 class="mb-4">Edit Project Income Statement</h3>
        <form action="/projectIncomeStatementExecuting/{{ $projectIncomeStatement->id }}/update" method="POST">
            @csrf
        <div class="row mb-3">
            <div class="col-md-6">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="description" id="description" class="form-control mb-3 text-white" value="{{ $projectIncomeStatement->description }}" required>
            </div>
            <div class="col-md-4">
                <label for="total" class="form-label text-white">Total</label>
                <input type="text" name="total" id="total" class="form-control mb-3 text-white" value="{{ $projectIncomeStatement->total }}" required>
            </div>
        </div>        
