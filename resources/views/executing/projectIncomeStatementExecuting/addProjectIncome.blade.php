    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-10">
            <div class="bg-secondary rounded h-100 p-4">
                <h2 class="mb-4">Add Project Income Statement Data </h2>
                <form action="/projectIncomeStatement/save" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <label for="" class="form-label text-white">Cost Category</label>
                            <input type="text" name="cost_category" id="" class="form-control mb-3 text-white"  required>
                        </div>
                        <div class="col-md-6">
