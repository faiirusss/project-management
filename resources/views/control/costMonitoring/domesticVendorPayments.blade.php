...
<div class="col-sm-12 col-xl-6">
    <div class="bg-secondary rounded h-100 p-4">
        <h2 class="mb-4">Pembayaran Vendor Dalam Negeri</h2>
        <form>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="" class="form-label">Expenditure Description</label>
                <input type="text" class="form-control" name="expenditure_description" id="">
            </div>
            <div class="mb-3">
